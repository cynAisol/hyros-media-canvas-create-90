...
import { Monitor, Smartphone, Globe, Code, Users, Award, ArrowRight, Mail, Phone, MapPin, Sun, Moon, Rocket, Star, Zap, Search, Palette, Laptop, Play, CheckCircle } from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="home" className="pt-20 min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-cyan-400/20 to-blue-600/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-purple-400/10 to-pink-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s' }}></div>
        </div>
            ...
            <div className="space-y-8">
              ...
              <div className="animate-fade-in space-y-6">
                <p className="text-xl md:text-2xl text-gray-600 max-w-2xl leading-relaxed">
                  We create <span className="font-semibold text-gray-900">stunning, high-performance websites</span> that drive real results for your business. From concept to launch, we're your digital transformation partners.
                </p>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <div className="flex items-center gap-2 bg-purple-50 px-3 py-2 rounded-full">
                    ...
                    <span className="text-sm font-medium text-purple-800">100% Satisfaction</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-in">
                <Button size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                  Start Your Project
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
                <Button size="lg" variant="outline" className="border-2 border-gray-300 hover:border-blue-600 text-gray-700 hover:text-blue-600 text-lg px-8 py-6 transition-all duration-300 group">
            ...
            <div className="relative animate-fade-in">
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-3xl shadow-2xl bg-gradient-to-br from-blue-50 to-purple-50 p-8">
                  ...
                  <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl opacity-60 animate-pulse" style={{ animationDelay: '1s' }}></div>
                </div>
                ...
                <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-bold text-gray-900 text-lg">Lightning Fast</div>
      ...
      <section id="portfolio" className="py-20 bg-gray-50 relative overflow-hidden">
        ...
        >
          ...
          <ellipse cx="300" cy="120" rx="80" ry="60" fill="#a78bfa" fillOpacity="0.5" />
        </svg>
        ...
        >
          ...
          <ellipse cx="80" cy="100" rx="60" ry="40" fill="#fbbf24" fillOpacity="0.4" />
        </svg>
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="flex justify-center mt-12">
            <div className="bg-white rounded-xl shadow-lg p-6 max-w-lg text-left border border-gray-100">
              ...
              <div className="text-gray-700">Each project represents our commitment to quality, innovation, and client success. Ready to see your vision come to life?</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Let's transform your vision into reality with cutting-edge technology and creative excellence!
            </p>
